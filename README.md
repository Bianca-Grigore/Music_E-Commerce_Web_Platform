...
A fully-featured, modern e-commerce web application built with **Django**. This platform is designed for a music store (selling CDs, vinyl, instruments, etc.) and features a custom-built **Premium Dark Mode UI**, secure user authentication, and a dynamic frontend shopping cart.
...
* **Filtering & Sorting:** Users can filter products by category, price range, stock levels, promotional campaigns, and addition dates. 
